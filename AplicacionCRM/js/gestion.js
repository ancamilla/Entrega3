...
if (!validarCampos(id_usuario, id_cliente, id_tipo_gestion, id_resultado, comentarios)) {
  return;
}
...
function validarCampos(id_usuario, id_cliente, id_tipo_gestion, id_resultado, comentarios) {
